...
void HConstfolding_step(void)
{
  ...
  HConstfolding_Y.Out1 = HConstfolding_DWork.UnitDelay_DSTATE *
    HConstfolding_DWork.UnitDelay1_DSTATE * HConstfolding_P.Gain2_Gain *
    HConstfolding_P.Gain3_Gain;
   ...
   *  Sum: '<Root>/Sum1'
   */
  HConstfolding_DWork.UnitDelay_DSTATE = (HConstfolding_P.Gain_Gain *
    HConstfolding_P.Constant_Value + HConstfolding_P.Constant1_Value) +
    HConstfolding_P.Constant4_Value;

  /* Update for UnitDelay: '<Root>/Unit Delay1' incorporates:
   *  Constant: '<Root>/Constant2'
   *  Gain: '<Root>/Gain1'
   */
  HConstfolding_DWork.UnitDelay1_DSTATE = HConstfolding_P.Gain1_Gain *
    HConstfolding_P.Constant2_Value;
