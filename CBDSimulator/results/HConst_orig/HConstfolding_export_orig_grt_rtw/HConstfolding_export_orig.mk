...
MAKECMD         = /usr/local/pkgs/MATLAB/R2012a/bin/glnx86/gmake
HOST            = UNIX
BUILD           = yes
...
MODEL                = HConstfolding_export_orig
MODULES              = HConstfolding_export_orig_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c 
MAKEFILE             = HConstfolding_export_orig.mk
MATLAB_ROOT          = /usr/local/pkgs/MATLAB/R2012a
ALT_MATLAB_ROOT      = /usr/local/pkgs/MATLAB/R2012a
MATLAB_BIN           = /usr/local/pkgs/MATLAB/R2012a/bin
MASTER_ANCHOR_DIR    = 
START_DIR            = /home/2011/boakes/Projects/BDOT/CBDSimulator/results/HConst_orig
S_FUNCTIONS          = 
S_FUNCTIONS_LIB      = 
SOLVER               = 
NUMST                = 1
...
MODELLIB                  = HConstfolding_export_origlib.a
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	-I$(START_DIR)/HConstfolding_export_orig_grt_rtw \
	-I$(START_DIR) \
	-I/home/2011/boakes/Projects/BDOT/CBDSimulator/examples \
...
ifeq ($(MODELREF_TARGET_TYPE), NONE)
    ...
    SRCS               += $(MODEL).$(TARGET_LANG_EXT) $(MAIN_SRC) rt_sim.c $(EXT_SRC) $(SOLVER)
else
