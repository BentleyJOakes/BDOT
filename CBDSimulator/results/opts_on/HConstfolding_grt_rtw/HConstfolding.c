...
void HConstfolding_step(void)
{
  ...
  HConstfolding_DWork.UnitDelay_DSTATE = 16.253;

  /* Update for UnitDelay: '<Root>/Unit Delay1' */
  HConstfolding_DWork.UnitDelay1_DSTATE = 36.599999999999994;
...
void HConstfolding_initialize(void)
{
  ...
  HConstfolding_M->Sizes.numBlocks = (12);/* Number of blocks */
  HConstfolding_M->Sizes.numBlockIO = (0);/* Number of block outputs */

  /* InitializeConditions for UnitDelay: '<Root>/Unit Delay' */
  HConstfolding_DWork.UnitDelay_DSTATE = 0.0;

  /* InitializeConditions for UnitDelay: '<Root>/Unit Delay1' */
  HConstfolding_DWork.UnitDelay1_DSTATE = 0.0;
}
