...
void HConstfolding_export_opt_step(void)
{
   ...
   */
  HConstfolding_export_opt_DWork.UnitDelay_DSTATE = 16.253;

  /* Update for UnitDelay: '<Root>/Unit Delay1' incorporates:
   *  Constant: '<Root>/Constant50'
   */
  HConstfolding_export_opt_DWork.UnitDelay1_DSTATE = 36.6;
...
void HConstfolding_export_opt_initialize(void)
{
  ...
  HConstfolding_export_opt_M->Sizes.numBlocks = (6);/* Number of blocks */
  HConstfolding_export_opt_M->Sizes.numBlockIO = (0);/* Number of block outputs */

  /* InitializeConditions for UnitDelay: '<Root>/Unit Delay' */
  HConstfolding_export_opt_DWork.UnitDelay_DSTATE = 0.0;

  /* InitializeConditions for UnitDelay: '<Root>/Unit Delay1' */
  HConstfolding_export_opt_DWork.UnitDelay1_DSTATE = 0.0;
}
