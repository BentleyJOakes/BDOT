...
void Flatten2_export_step(void)
{
   ...
   *  Inport: '<Root>/In1'
   */
  rtb_Gain2 = Flatten2_export_U.In1 * Flatten2_export_P.Constant_Value_a;

  /* Product: '<S1>/Product3' incorporates:
   *  Constant: '<Root>/Constant2'
   */
  rtb_Gain2 *= Flatten2_export_P.Constant2_Value;

  /* Sum: '<S1>/Sum' incorporates:
   *  Constant: '<S1>/Constant'
   */
  rtb_Gain2 += Flatten2_export_P.Constant_Value;

  /* Gain: '<Root>/Gain2' */
  rtb_Gain2 *= Flatten2_export_P.Gain2_Gain;
...
void Flatten2_export_initialize(void)
{
  ...
  Flatten2_export_M->Sizes.numBlockPrms = (4);/* Sum of parameter "widths" */
}
