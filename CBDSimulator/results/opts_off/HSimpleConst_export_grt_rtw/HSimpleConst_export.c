...
void HSimpleConst_export_step(void)
{
   ...
   *  Inport: '<Root>/In1'
   */
  HSimpleConst_export_Y.Out1 = HSimpleConst_export_P.Constant23_Value *
    HSimpleConst_export_U.In1;
...
void HSimpleConst_export_initialize(void)
{
  ...
  HSimpleConst_export_M->Sizes.numBlockPrms = (1);/* Sum of parameter "widths" */
}
