...
void HConstfolding_export_initialize(void)
{
  ...
  HConstfolding_export_M->Sizes.numBlocks = (8);/* Number of blocks */
  HConstfolding_export_M->Sizes.numBlockIO = (0);/* Number of block outputs */
  HConstfolding_export_M->Sizes.numBlockPrms = (6);/* Sum of parameter "widths" */

  /* InitializeConditions for UnitDelay: '<Root>/Unit Delay' */
  HConstfolding_export_DWork.UnitDelay_DSTATE =
    HConstfolding_export_P.UnitDelay_X0;

  /* InitializeConditions for UnitDelay: '<Root>/Unit Delay1' */
  HConstfolding_export_DWork.UnitDelay1_DSTATE =
    HConstfolding_export_P.UnitDelay1_X0;
}
