...
void Flatten2_step(void)
{
   ...
   *  Inport: '<Root>/In1'
   */
  rtb_Gain2 = Flatten2_U.In1 * Flatten2_P.Constant_Value_c;

  /* Product: '<S2>/Product3' incorporates:
   *  Constant: '<S1>/Constant2'
   */
  rtb_Gain2 *= Flatten2_P.Constant2_Value;

  /* Sum: '<S2>/Sum' incorporates:
   *  Constant: '<S2>/Constant'
   */
  rtb_Gain2 += Flatten2_P.Constant_Value;

  /* Gain: '<S1>/Gain2' */
  rtb_Gain2 *= Flatten2_P.Gain2_Gain;
...
void Flatten2_initialize(void)
{
  ...
  Flatten2_M->Sizes.numBlockPrms = (4);/* Sum of parameter "widths" */
}
