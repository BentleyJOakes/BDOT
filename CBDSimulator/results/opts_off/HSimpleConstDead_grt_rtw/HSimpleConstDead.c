...
void HSimpleConstDead_step(void)
{
   ...
   */
  HSimpleConstDead_Y.Out1 = HSimpleConstDead_P.Constant2_Value *
    HSimpleConstDead_U.In1;

  /* Sum: '<Root>/Sum' incorporates:
   *  Constant: '<Root>/Constant1'
   *  Constant: '<Root>/Constant2'
   */
  rtb_Sum = HSimpleConstDead_P.Constant2_Value +
    HSimpleConstDead_P.Constant1_Value;
...
void HSimpleConstDead_initialize(void)
{
  ...
  HSimpleConstDead_M->Sizes.numBlocks = (5);/* Number of blocks */
  HSimpleConstDead_M->Sizes.numBlockIO = (0);/* Number of block outputs */
  HSimpleConstDead_M->Sizes.numBlockPrms = (2);/* Sum of parameter "widths" */
}
