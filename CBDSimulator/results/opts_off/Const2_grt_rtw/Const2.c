...
void Const2_step(void)
{
   ...
   */
  Const2_Y.Out1 = Const2_P.Constant3_Value * Const2_P.Constant2_Value;

  /* Gain: '<Root>/Gain' incorporates:
   *  Constant: '<Root>/Constant'
   */
  rtb_Product = Const2_P.Gain_Gain * Const2_P.Constant_Value;

  /* Product: '<Root>/Product' incorporates:
   *  Constant: '<Root>/Constant1'
   */
  rtb_Product *= Const2_P.Constant1_Value;

  /* Switch: '<Root>/Switch' incorporates:
   *  Constant: '<Root>/Constant2'
   */
  if (!(Const2_P.Constant2_Value >= Const2_P.Switch_Threshold)) {
    Const2_Y.Out1 = rtb_Product;
  }
...
void Const2_initialize(void)
{
  ...
  Const2_M->Sizes.numBlocks = (9);     /* Number of blocks */
  Const2_M->Sizes.numBlockIO = (0);    /* Number of block outputs */
  Const2_M->Sizes.numBlockPrms = (6);  /* Sum of parameter "widths" */
}
