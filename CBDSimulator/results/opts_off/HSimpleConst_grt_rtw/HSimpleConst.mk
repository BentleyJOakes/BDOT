...
MODEL                = HSimpleConst
MODULES              = HSimpleConst_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c 
MAKEFILE             = HSimpleConst.mk
...
ADD_INCLUDES = \
	-I$(START_DIR)/HSimpleConst_grt_rtw \
	-I$(START_DIR) \
