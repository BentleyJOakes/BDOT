...
void HSimpleConst_step(void)
{
   ...
   */
  HSimpleConst_Y.Out1 = HSimpleConst_P.Constant_Value +
    HSimpleConst_P.Constant1_Value;

  /* Product: '<Root>/Product' incorporates:
   *  Inport: '<Root>/In1'
   */
  HSimpleConst_Y.Out1 *= HSimpleConst_U.In1;
...
void HSimpleConst_initialize(void)
{
  ...
  HSimpleConst_M->Sizes.numBlockPrms = (2);/* Sum of parameter "widths" */
}
